pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamiohAbbottrj/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('abbottrj-225')   // <---- Change this to match your kubernetes cluster credentials
    }
